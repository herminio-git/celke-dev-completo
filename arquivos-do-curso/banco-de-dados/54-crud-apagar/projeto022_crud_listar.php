...
<html lang="pt-br">
	...
	<body>
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
				...
				echo "Nível de acesso: " . $row_usuario['nome_niv_ac'] . "<br>";
				echo "<a href='projeto025_crud_editar.php?id=" . $row_usuario['id'] . "'>Editar</a><br>";
				echo "<a href='projeto027_crud_apagar.php?id=" . $row_usuario['id'] . "'>Apagar</a><hr>";
			}
		?>
	</body>
</html>